...
class GetTypeCreateAppointmentServiceIdUsecase
    implements UseCase<List<TypeCreateAppointmentServiceEntity>, NoParams> {
  final ScheduleRepository repository;

  GetTypeCreateAppointmentServiceIdUsecase(this.repository);

  @override
  Future<Either<Failure, List<TypeCreateAppointmentServiceEntity>>> call(
      NoParams params) async {
    try {
      Log.info("GetTypeCreateAppointmentServiceIdUsecase");
