...
class GetListHeartRateUsecase
    implements UseCase<List<HeartRateDetailEntity>, GetListHealthIndexParams> {
  final AccountRepository repository;

  GetListHeartRateUsecase(this.repository);

  @override
  Future<Either<Failure, List<HeartRateDetailEntity>>> call(
      GetListHealthIndexParams params) async {
    try {
      Log.info("GetHealthMetrictsUsecase");
      final result = await repository.getListHeartRate(
        params.start,
        params.end,
        params.offset,
        params.limit,
