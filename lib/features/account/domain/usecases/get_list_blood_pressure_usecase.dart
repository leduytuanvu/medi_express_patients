...
class GetListBloodPressureUsecase
    implements
        UseCase<List<BloodPressureDetailEntity>, GetListHealthIndexParams> {
  final AccountRepository repository;

  GetListBloodPressureUsecase(this.repository);

  @override
  Future<Either<Failure, List<BloodPressureDetailEntity>>> call(
      GetListHealthIndexParams params) async {
    try {
      Log.info("GetHealthMetrictsUsecase");
      final result = await repository.getListBloodPressure(
        params.start,
        params.end,
        params.offset,
        params.limit,
