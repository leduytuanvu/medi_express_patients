...
class GetListWeightUsecase
    implements UseCase<List<WeightDetailEntity>, GetListHealthIndexParams> {
  final AccountRepository repository;

  GetListWeightUsecase(this.repository);

  @override
  Future<Either<Failure, List<WeightDetailEntity>>> call(
      GetListHealthIndexParams params) async {
    try {
      Log.info("GetHealthMetrictsUsecase");
      final result = await repository.getListWeight(
        params.start,
        params.end,
        params.offset,
        params.limit,
