...
class UaPage extends BaseStatelessWidget {
  ...
  Widget buildContent(BuildContext context) {
    accountController.getListAcidUric();
    return Scaffold(
                  ...
                  child: Obx(() {
                    return ListView.builder(
                      ...
                      itemCount: accountController
                          .accountState.listAcidUricDetail.length,
                      itemBuilder: (context, index) {
                        ...
                        final item = accountController
                            .accountState.listAcidUricDetail[reverseIndex];
                        return Column(
                          children: [
                            context.wp(1).sbh,
                            Row(
                              children: [
                                Text(
                                  item.acidUric.isEmpty
                                      ? "0 umol/l"
                                      : item.acidUric + " umol/l",
