...
class BloodPressurePage extends BaseStatelessWidget {
  final AccountController accountController = Get.find<AccountController>();

  BloodPressurePage({super.key});

  @override
  Widget buildContent(BuildContext context) {
    accountController.getListBloodPressure();
    return Scaffold(
                  ...
                  child: Obx(() {
                    return ListView.builder(
                      ...
                      itemCount: accountController
                          .accountState.listBloodPressureDetail.length,
                      itemBuilder: (context, index) {
                        ...
                        final item = accountController
                            .accountState.listBloodPressureDetail[reverseIndex];
                        return Column(
                          children: [
                            context.wp(1).sbh,
                            Row(
                              children: [
                                Text(
                                  item.systolicBloodPressure.isEmpty
                                      ? "0 mmHg"
                            ...
                            if (index !=
                                accountController.accountState
                                        .listBloodPressureDetail.length -
                                    1) ...{
                              Divider(
