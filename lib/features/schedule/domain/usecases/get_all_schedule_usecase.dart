...
class GetAllScheduleUsecase implements UseCase<List<ScheduleEntity>, String> {
  final ScheduleRepository repository;

  GetAllScheduleUsecase(this.repository);

  @override
  Future<Either<Failure, List<ScheduleEntity>>> call(String params) async {
    try {
      Log.info("GetAllScheduleUsecase");
      final result = await repository.getAllSchedule(params);
